...
export default function AiDialog(props: AiDialogProps): JSX.Element {
  ...
  let examples = [
    '帮我设计个好奇号火星车的介绍项目，我会拿他做演讲，注重高科技的部件，约3个场景。',
    '做一个讲解电机工作原理的项目，我准备用他讲课。场景多些，要让初中生能清晰的理解。',
    '给每一个步骤的文本生成对应的英文版本，并对他润色，让原文和英文都更加生动有趣。',
    '我在这一步要介绍蜜蜂采蜜的过程，但我不知道怎么样做场景更让人感兴趣，给我点建议。',
